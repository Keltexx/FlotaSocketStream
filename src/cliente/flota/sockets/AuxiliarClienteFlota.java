...
public class AuxiliarClienteFlota {
	 ...
	 * @throws IOException
	 */
	public void fin() throws IOException, SocketException {
		// Por implementar
	 ...
	 * @throws IOException
	 */
	public String getBarco(int idBarco) throws IOException, SocketException{

		// Por implementar

		String stream = GETBARCO + "#" + idBarco;
		mySocket.sendMessage(stream);
		String barco = mySocket.receiveMessage();
		return barco; // cambiar por el retorno correcto
	...
	public String[] getSolucion() throws IOException {
		...
		return solucion; // cambiar por el retorno correcto
